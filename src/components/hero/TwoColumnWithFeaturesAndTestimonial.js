...
export default ({
  heading = "Match with Local Professionals.",
  description = "Thousands of homeowners connect with the right pro every week for their remodeling projects. Ready to find yours?",
          ...
          <Row>
            <TextColumn>
              ...
              <SubscribeForm method="get" action="#">
                <Input type="email" placeholder="What service do you need?" />
                <SubscribeButton type="submit">Search</SubscribeButton>
              </SubscribeForm>
            </TextColumn>
            <ImageColumn>
              <ImageContainer>
