...
const Column = styled.div`
  ${tw`w-1/2 md:w-1/5 mb-8 md:mb-0 text-sm sm:text-base text-center md:text-left`}
`;

const Card = styled.div`
  ${tw`min-w-0 flex flex-col mx-auto max-w-xs items-center px-6 py-10 border-2 border-dashed border-primary-500 rounded-lg mt-12`}
  .imageContainer {
...
export default () => {
  ...
  return (
    <Container>
      ...
      <br /> <br />
        <Heading> <br /><span tw="text-primary-500">Services</span></Heading>
        {cards.map((card, i) => (
          <Column key={i}>
            <Card>
